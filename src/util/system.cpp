...
const char * const BITCOIN_CONF_FILENAME = "nurocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nurocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nurocoin";
#else
    // Unix
    return pathRet / ".nurocoin";
#endif
#endif
}
