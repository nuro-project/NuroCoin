...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nurocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nurocoin-tx [options] <hex-tx> [commands]  Update hex-encoded nurocoin transaction\n" +
            "or:     nurocoin-tx [options] -create [commands]   Create hex-encoded nurocoin transaction\n" +
            "\n";
