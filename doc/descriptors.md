# Support for Output Descriptors in Nurocoin Core

Since Nurocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Nurocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nurocoin Core wallets, a convenience function `combo` is
