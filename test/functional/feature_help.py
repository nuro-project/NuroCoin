...
"""Verify that starting nurocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nurocoin with -h for help text")
        ...
        self.log.info("Start nurocoin with -version for version information")
        ...
        self.log.info("Start nurocoind with -fakearg to make sure it does not start")
